...
default location. The default generally requires using sudo.
```
...
When complete, you should have an executable called blippd and puts it
on your path. Running =blippd --help= should give a run down of the
arguments it takes.
